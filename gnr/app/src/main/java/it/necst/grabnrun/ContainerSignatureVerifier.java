...
class ContainerSignatureVerifier {
    private static final String TAG_SECURE_DEX_CLASS_LOADER = ContainerSignatureVerifier.class.getSimpleName();

    private final PackageManager packageManager;
    private final CertificateFactory certificateFactory;

    ContainerSignatureVerifier(
            PackageManager packageManager, CertificateFactory certificateFactory) {
    ...
    boolean verifyContainerSignatureAgainstCertificate(String containerPath, X509Certificate verifiedCertificate) {
